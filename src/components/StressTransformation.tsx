      ...
      <div className="container mx-auto px-4">
        <div className="max-w-[80%] mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {transformations.map((item, index) => <Card key={index} className="group hover:shadow-xl transition-all duration-300 border border-border hover:border-blue-300 dark:hover:border-blue-700">
